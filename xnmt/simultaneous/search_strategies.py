...
from xnmt.simultaneous.translators import SimultaneousTranslator, SimultaneousState
...
class SimultaneousGreedySearch(search_strategies.SearchStrategy):
  ...
  def generate_output(self,
    ...
    while current_state.to_write < self.max_len:
      ...
      if action == SimultaneousTranslator.Action.READ:
        # Reading
        ...
        current_state = current_output.state.write(next_word)
        # Scoring
    ...
    return [search_strategies.SearchOutput(words, attentions, score, logsoftmaxes, [], [])]
