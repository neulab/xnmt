...
if xnmt.backend_dynet:
  ...
  class XnmtDynetOptimizer(XnmtOptimizer):
    """
    ...
    def __init__(self, optimizer: dy.Trainer, skip_noisy: bool = False, clip_threshold: numbers.Real = 5.0) -> None:
      self.optimizer = optimizer
      self.optimizer.set_clip_threshold(clip_threshold)
  ...
  class SimpleSGDTrainer(XnmtDynetOptimizer, Serializable):
    """
  ...
  class MomentumSGDTrainer(XnmtDynetOptimizer, Serializable):
    """
  ...
  class AdagradTrainer(XnmtDynetOptimizer, Serializable):
    """
    Adagrad optimizer
  ...
  class AdamTrainer(XnmtDynetOptimizer, Serializable):
    """
    Adam optimizer
  ...
  class NoamTrainer(XnmtDynetOptimizer, Serializable):
    """
...
if xnmt.backend_torch:
  ...
  class XnmtTorchOptimizer(XnmtOptimizer):
    """
  ...
  class AdamTrainer(XnmtTorchOptimizer, Serializable):
    """
    Adam optimizer
