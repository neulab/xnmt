...
class Linear(object):
  ...
  Args:
    ...
    param_init (:class:`xnmt.param_init.ParamInitializer`): how to initialize weight matrices
    bias_init (:class:`xnmt.param_init.ParamInitializer`): how to initialize bias vectors
  """
